-- =============================================================================
-- seed-data.sql — Course Management Platform Database
-- =============================================================================
-- Simulates the database behind a real-world course platform (DataTalks.Club)
-- where a production incident destroyed the database containing student work,
-- enrollments, homework answers, and leaderboard data.
--
-- The original platform managed multiple "Zoomcamp" cohorts with:
--   - Thousands of enrolled students
--   - Hundreds of homework questions across modules
--   - 1.9 million+ rows in the answers table (courses_answer)
--   - Leaderboard rankings and OAuth login providers
--
-- This seed file recreates the schema and populates it at a representative
-- scale (~2,000 students, 50,000+ answer rows) so the incident simulation
-- feels realistic without requiring gigabytes of storage.
--
-- Usage:
--   psql -U admin -d course_platform -f seed-data.sql
-- =============================================================================

BEGIN;

-- ─────────────────────────────────────────────
-- 1. SCHEMA — DROP existing tables (cascade) to allow re-runs
-- ─────────────────────────────────────────────
...
-- =============================================================================
-- Quick sanity check — run after seeding to verify row counts
-- =============================================================================
DO $$
DECLARE
    r RECORD;
